...
public class Util {
    ...
    public static List<Category> getDummyData(){
        return new ArrayList<Category>(){{
            ...
            add(new Category("Cantantes", "Adivina los cantantes", "http://info7rm.blob.core.windows.net.optimalcdn.com/images/2017/11/26/musica.jpg"));
            add(new Category("Libros", "Adivina los libros", "http://www.raicesdeeuropa.com/wp-content/uploads/li.jpg"));
